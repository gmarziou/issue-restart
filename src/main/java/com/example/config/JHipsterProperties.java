...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "sampleToken@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "sampleToken API";

        private String description = "sampleToken API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "sampleToken";
